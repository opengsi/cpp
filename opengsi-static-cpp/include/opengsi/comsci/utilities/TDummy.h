...
#ifndef __OPEN_GSI_COMSCI_UTILITIES_TDUMMY_H_
#define __OPEN_GSI_COMSCI_UTILITIES_TDUMMY_H_
...
template<typename _Any_> _Any_ TDummy<_Any_>::value = _Any_();

OPENGSI_END_NAMESPACE

#endif  /* __OPEN_GSI_COMSCI_UTILITIES_TDUMMY_H_ */
